...
- Three.js (r128) for 3D device mockups, vendored locally
- IndexedDB for local storage
- JSZip for batch export, vendored locally
- Google Fonts API for font picker (the only external runtime dependency)
